...
let sizesSpeed = [sizes, speeds];
    sizesSpeed.forEach(group => {
...
let adresses = [fromInput, toInput]
    adresses.forEach((input) => {
...
calcButton.addEventListener('click', () => {
    ...
    mapRoute.model.events.add('requestsuccess', () => {
        try {
            ...
            const size = document.querySelector('.main-size-card.is-active')
                .dataset.value
